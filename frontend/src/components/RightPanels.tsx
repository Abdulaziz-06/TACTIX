    ...
    <div className="relative h-full flex shrink-0 z-40">
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className={`w-8 h-16 flex flex-col items-center justify-center rounded-l-xl border border-r-0 border-white/10 shadow-[0_0_20px_rgba(0,0,0,0.5)] transition-all duration-300 ${isOpen
