    ...
    <div className="absolute bottom-8 left-8 flex flex-col gap-4 z-30">
      ...
      <div className="glass p-1.5 rounded-2xl flex items-center gap-1.5 backdrop-blur-3xl shadow-2xl border border-white/5">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all ${mapMode === '3D' ? 'bg-primary text-primary-foreground shadow-lg' : 'hover:bg-white/5 text-muted-foreground hover:text-foreground'
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all ${mapMode === '2D' ? 'bg-primary text-primary-foreground shadow-lg' : 'hover:bg-white/5 text-muted-foreground hover:text-foreground'
            }`}
        >
      ...
      <div className="glass p-3 rounded-3xl flex flex-col gap-2 backdrop-blur-3xl shadow-2xl min-w-[200px] border border-white/5">
        ...
        {layerItems.map((layer) => (
          <div
            ...
            className={`flex items-center justify-between p-2 rounded-xl cursor-pointer hover:bg-white/5 transition-all border border-transparent ${activeLayers.includes(layer.id) ? 'border-white/5' : ''
              }`}
          >
